export const DEFAULT_OUTSTANDING_LINE = 1120
export const DEFAULT_GOOD_LINE = 960
export const DEFAULT_COMPETENT_LINE = 800
export const DEFAULT_DEVELOPING_LINE = 640
